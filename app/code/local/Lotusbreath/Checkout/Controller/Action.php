...
class Lotusbreath_Checkout_Controller_Action extends Mage_Core_Controller_Front_Action {
    ...
    protected function _return($return){
        ...
        if($this->_updateItems == 'all'){
            $definedBlocks = $this->_getDefinedBlocks();
            $this->_updateItems = array_keys($definedBlocks);
        }
        ...
        */
        ...
        Mage::dispatchEvent('osc_controller_response_before_return', array('controller' => $this, 'return' => &$return));
    ...
    protected function _getDefinedBlocks(){
        ...
        $definedBlocksParam = new Varien_Object($definedBlocks);
        Mage::dispatchEvent('osc_add_more_block', array('controller' => $this, 'defined_blocks' => &$definedBlocksParam));

        return $definedBlocksParam->getData();
    }
